    ...
    return (
        <div>
            <Menu fluid vertical className="leftMenuOne" >
                <Menu.Item className='leftMenu' as={NavLink} to="/jobAdvertisement"
                    style={{ backgroundColor: 'black', color: 'white' }} name="Anasayfa"> Anasayfa </Menu.Item>
                ...
                <Menu.Item className="leftMenu" as={NavLink} to="/10/jobAdvertisementList" >İş İlanları</Menu.Item>
